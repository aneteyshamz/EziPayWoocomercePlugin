...
if(isset($_SESSION['ezipay_payload']) && isset($_SESSION['ezipay_order_id']) && isset($_SESSION['ezipay_checkout_response'])){

	//Checkout Status URL
	$checkout_url = 'https://payments.ezipaygh.com/api/status/'.$_SESSION['ezipay_checkout_response']->checkouttransid;
	
	//Set http headers
	$headers = array();
	$headers[] = "Content-Type: application/json";
	$headers[] = "apikey: ".$_SESSION['ezipay_payload']['apikey'];
	$headers[] = "appid: ".$_SESSION['ezipay_payload']['appid'];
	...
	if(empty($response_error)){
		...
		if(isset($response['status']) && $response['status'] == 'PAID'){
			...
			$order = wc_get_order( $_SESSION['ezipay_order_id'] );
			wc_reduce_stock_levels($_SESSION['ezipay_order_id']);
			$order->payment_complete();
			$order->add_order_note('Payment successfully processed, Checkout ID : '.$_SESSION['ezipay_checkout_response']->checkouttransid);
			...
			echo'<!doctype html>
				<html lang="en">
					<head>
						...
						<link rel="icon" type="image/x-icon" href="../assets/images/ezipay-ico.png">
					...
					<body class="bg--secondary">
						...
						<div class="r-o">
							<div class="s-o n-f-s">
								<img src="../assets/images/ezipay-pay.png" style="margin-top: 25px;" width="20%" />
								<div id="n-f-s">
									<div>
													...
													<div class="col-md-12">
														<div class="pricing pricing-3 text-center">
															<div class="pricing__head bg--secondary boxed">
																...
																<img class="img-80" alt="Image" class="logo" src="'.$_SESSION['ezipay_payload']['logolink'].'" width="20%" />
								...
								<div class="container">
									<div class="row">
										<div class="col-md-6 center-block text-center text-center-xs">
											<img alt="Image" class="logo" src="../assets/images/ezipay-pay.png" />
											<span class="type--fine-print">&copy;
												<span class="update-year"></span> ezipay Payment Service.</span>
											<a class="type--fine-print receipt-hide" target="_blank" href="https://www.ezipayonline.com/assets/policies/ezipay-privacy-policy.pdf">Privacy</a>
											<a class="type--fine-print receipt-hide" target="_blank" href="https://www.ezipayonline.com/assets/policies/terms-of-use-policy-updated.pdf">Terms</a>
										</div>
									</div>
									<!--end of row-->
								</div>
						...
						<script src="../assets/js/ezipay-checkout-status.js"></script>
					</body>
				</html>';			
